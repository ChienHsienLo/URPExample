#ifndef INSTANCED_LIT_INPUT_INCLUDED
#define INSTANCED_LIT_INPUT_INCLUDED
...
float2 _WindTextureScale;
float2 _WindTextureSpeed;
float2 _WindContrast;
float _WindDirection;
float _GrassStiffness;
float4 _WindHighLight;
#ifdef INSTANCED_ENABLE
    StructuredBuffer<float4x4> _O2WBuffer;
    StructuredBuffer<float4x4> _W2OBuffer;
    StructuredBuffer<uint> _VisibleIDBuffer;
#endif

uniform float4 _PlayerPosition;
uniform float _PlayerPositionHeightOffset;


CBUFFER_END

uniform sampler2D _TerrainColor;
...
#endif // INSTANCED_LIT_INPUT_INCLUDED
